...
function setupOptions (options) {
	...
	options.config.file			= options.config.file		|| path.join(root, 'config.json');
	
	//
	// System options
	//
	options.system				= options.system			|| {};
	// define the SC to SRE communications base port to start with
	options.system.srePort		= options.system.srePort	|| 5500;
 ...
 * @param {Object} options Options for nconf store.
