 ...
 * @param {String} socket The socket directory to use
 * @param {String} socketFile The cliServer socket file to use
 * @param {String} logs The location to write the logging files to
 * @param {Function} cb Callbck to continue with (err, cliServer)
 */
exports.start = function(options, socket, socketFile, logs, cb) {
	...
	// location of the APIE, SRE and SSE socket files
	options.socket = options.socket || socket;
	options.logging = { location: logs };
